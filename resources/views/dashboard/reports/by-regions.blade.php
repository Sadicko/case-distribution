...
@section('title', 'Reports by region')
        ...
        <div class="row align-items-center">
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    <h3 class="h4 mb-0"><i class="fas fa-chart-pie"></i> Reports: By region</h3>
                </div>
            </div>
        </div>
    ...
    <div class="container-xxl">
        <div class="card mb-3">
            <div class="card-body basic-custome-color">
                ...
                @livewire('bail-report-by-region', ['legalYearStart' => $legalYearStart, 'legalYearEnd' => $legalYearEnd])
