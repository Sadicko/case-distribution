    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                ...
                <input type="text" id="username" name="username" class="mt-1 block form-control"
            ...
            <div class="col-md-4 mb-4">
                <label for="registry">Registry <small class="text-muted">(You can not edit)</small></label>
                <input type="text" id="registry"  class="mt-1 block form-control"
                       value="{{ $user->registries?->name ?? '-' }}" readonly="readonly" disabled="" />
            </div>
            <div class="col-md-4 mb-4">
                <label for="court">Court room <small class="text-muted">(You can not edit)</small></label>
                <input type="text" id="court"  class="mt-1 block form-control"
                       value="{{ $user->courts?->name ?? '-' }}" readonly="readonly" disabled="" />
            </div>
        </div>
