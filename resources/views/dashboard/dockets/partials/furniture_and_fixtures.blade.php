<h5 class="text-info text-uppercase mb-4">Furniture and Fixtures</h5>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-4 mb-3">
            ...
            <select class="form-control select2" name="material" required>
                <option value="">Choose status</option>
                @foreach(furnitureMaterials() as $material)
        ...
        <div class="col-md-4 mb-3">
            <label for="dimensions" class="form-label">Dimensions (length, width, height)</label>
