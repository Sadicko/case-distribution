    ...
    <div class="container-xxl">
        <div class="row align-items-center">
            <div class="border-0 mb-4">
                ...
                <h3 class="h4 mb-0">Create court</h3>
            ...
            <div class="card mb-3">
              {{--   <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                ...
                <div class="card-body basic-custome-color">
                    <form action="{{ route('courts.create') }}" method="POST">
                        @csrf

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="court_name" class="form-label">Court name*</label>
                                <input type="text" class="form-control" name="court_name" id="court_name" value="{{ old('court_name') }}" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="court_code" value="{{ old('court_code') }}">
