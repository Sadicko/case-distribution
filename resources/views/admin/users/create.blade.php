                    ...
                    <form id="auth-form" class="form-auth-small text-left" method="POST" action="{{route('admin.users.create')}}">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="form-group mb-3 col-md-6">
                                ...
                                <input type="password" name="password_confirmation" class="form-control round   @error('password_confirmation') is-invalid @enderror" id="password_confirmation" placeholder="Confirm password" value="{{ config('ecds.default_password') }}" readonly>
