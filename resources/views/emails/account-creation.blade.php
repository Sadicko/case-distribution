...
@section('title', 'Account Notification')
                ...
                <tr>
                    <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                        ...
                        <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                            Kindly find below your account details to access the {{ config('app.name') }} portal.
                            <br>
                            <br>
                            <em style="font-weight: bolder; color: #3d7881;">Username: {{ $user->username }}</em>
                            <br>
                            <em style="font-weight: bolder; color: #3d7881">Password: {{ config('bail.default_password') }}</em>
                        </p>
                            ...
                            <tr>
                                <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px;">
                                        ...
                                        <span style="color: #6610f2">{{ config('app.url') }}</span>
                                    </p>
                                </td>
                            </tr>
                        </table>
